...
public class AzureADServices implements LDAPServices {
	...
	public void testLdapConnection(LDAPServerConfiguration ldapServerConfiguration, String user, String password)
		...
		/*try {
			...
			throw new CouldNotConnectUserToLDAP(t);
		}*/
	}

	private String getAccessToken(LDAPServerConfiguration ldapServerConfiguration)
			throws Throwable {
			...
			Future<AuthenticationResult> authenticationResultFuture = authenticationContext
					.acquireToken(ldapServerConfiguration.getResource(),
							new ClientCredential(ldapServerConfiguration.getClientId(),
									ldapServerConfiguration.getClientSecret()),
							null);
