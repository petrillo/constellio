...
public class SolrBigVaultServer extends BaseBigVaultServer implements Cloneable {
	...
	public SolrBigVaultServer(String name, BigVaultLogger bigVaultLogger, SolrServerFactory solrServerFactory
	...
	public SolrBigVaultServer(String name, BigVaultLogger bigVaultLogger, SolrServerFactory solrServerFactory,
		...
		super(name, extensions, listeners);
	...
	@Override
	public SolrBigVaultServer cloneServer() {
		return new SolrBigVaultServer(name, bigVaultLogger, solrServerFactory, extensions, this.listeners);
	}
